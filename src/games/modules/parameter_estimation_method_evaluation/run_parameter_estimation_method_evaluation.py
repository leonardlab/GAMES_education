...
def run_parameter_estimation_method_evaluation(
    ...
    pem_evaluation_data_list, chi_sq_pem_evaluation_criterion, r_sq_pem_evaluation_criterion = generate_pem_evaluation_data(
    ...
    plot_pem_evaluation(df_list, chi_sq_pem_evaluation_criterion, r_sq_pem_evaluation_criterion)
